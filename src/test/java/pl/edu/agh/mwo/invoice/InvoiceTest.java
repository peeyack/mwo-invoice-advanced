...
public class InvoiceTest {
	...
	public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
		...
		assertBigDecimalsAreEqual(invoice.getGrossTotal(), invoice.getGrossTotal());
	}
	...
	public void testInvoiceHasProperSubtotalForManyProduct() {
		...
		assertBigDecimalsAreEqual("259.99", invoice.getGrossTotal());
	}
	...
	public void testInvoiceHasPropoerSubtotalWithQuantityMoreThanOne() {
		...
		assertBigDecimalsAreEqual("739.97", invoice.getGrossTotal());
	}
